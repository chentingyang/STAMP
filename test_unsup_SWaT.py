...
parser.add_argument('--test_alpha', type=float, default=.8, help='test_alpha')
parser.add_argument('--test_beta', type=float, default=.1, help='test_beta')
parser.add_argument('--test_gamma', type=float, default=0.1, help='test_gamma')
...
swat_unsup_data = np.load("/home/chenty/STAT-AD/data/SWaT/selected_data/DBSCAN/result_method1_SGATAE.npz")
...
np.savez('/home/chenty/STAT-AD/weights/node_weights_SWAT_unsup_train_SGATAE.npz', a=sort_graph_weight_out, b=sort_graph_weight_in, c=sort_score_weight)
'''
'''
print()
print("================= Find best f1 from score: normalization loss ... =================")
